...
public class c extends InputConnectionWrapper {
    ...
    public c(InputConnection inputConnection, boolean z2, e eVar) {
    ...
    public boolean performPrivateCommand(java.lang.String r12, android.os.Bundle r13) {
        ...
        L_0x0062:
            ...
            i0.f r10 = new i0.f     // Catch:{ all -> 0x007d }
            r10.<init>(r6, r7, r8)     // Catch:{ all -> 0x007d }
            i0.d r0 = (i0.d) r0     // Catch:{ all -> 0x007d }
        ...
        L_0x008a:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.c.performPrivateCommand(java.lang.String, android.os.Bundle):boolean");
    }
}
